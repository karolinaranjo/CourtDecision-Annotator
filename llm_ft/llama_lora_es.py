...
class Llama_Lora_es(LLM_Lora):
    def __init__(self,
                 base_model: str = "clibrain/Llama-2-7b-ft-instruct-es",
        ...
        """
        Initialize the Llama Lora model for Spanish language.
    ...
    def load_base_model(self):
        """
        Load the base language model for preparation.
